...
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "")  # 中转API的key，格式如 sk-xxxxxx
GEMINI_BASE_URL = os.environ.get("GEMINI_BASE_URL", "https://api.newapi.pro/v1beta")  # 中转API地址

MODEL_NAME = "gemini-2.5-flash-image"  # 图像生成模型
