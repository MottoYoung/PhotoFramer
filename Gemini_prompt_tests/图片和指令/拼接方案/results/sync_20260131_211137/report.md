...
> 生成时间: 2026-01-31 21:11:52
> 测试时间: 20260131_211137
...
|------|----------|-------------|---------|---------|-----------|--------|
| 1 | `parallel_v2_default` | 14939 | 14939 | 14939 | 0 | 100% |
...
1.  **Layout**: The final image MUST be a **2x2 Grid**.
    ...
    * Bottom-Left Panel
    * Bottom-Right Panel
2.  **Separators**: You MUST draw thick, bright **NEON GREEN lines** (纯亮绿色线条) to separate the 4 panels. There should be one vertical green line down the center and one horizontal green line across the middle, forming a green cross.
